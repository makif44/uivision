...
$timeout_seconds = 120 #max time in seconds allowed for macro to complete (change this value if  your macros takes longer to run)
$path_downloaddir = "C:\Users\Administrator.TECHNE\Downloads\" #where the kantu log file is stored ("downloaded") *THIS MUST BE THE BROWSER DOWNLOAD FOLDER*, as specified in the browser settings
$path_autorun_html = "C:\Users\Administrator.TECHNE\Desktop\uivision\ui.vision.html"
...
$testreport = "C:\Users\Administrator.TECHNE\Desktop\testreport.txt"
...
$result = PlayAndWait2 RPA_Demo/Read_pdf 0 #run the macro and keep browser open, so second macro continues in same tab.
